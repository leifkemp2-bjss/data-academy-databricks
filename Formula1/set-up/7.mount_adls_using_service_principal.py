...
def mount_adls():   
    ...
    dbutils.fs.mount(
      source = f"wasbs://demo@formula1dllk.blob.core.windows.net",
      mount_point = f"/mnt/formula1dllk/demo",
      extra_configs = {f"fs.azure.account.key.formula1dllk.blob.core.windows.net": account_key}
    )
...
dbutils.fs.unmount('/mnt/formula1dllk/demo')
